...
(function(factory) {
        ...
        if (_.options.accessibility && _.options.autoplay) {
            ...
            if (_.options.pauseButton) {
                _.$pauseButton = $(_.options.pauseButton)
                    ...
                    .attr({
                        "aria-label": _.options.pauseLabel,
                        "data-action": 'pause'
                    })
            } else {
                _.$pauseButton = $('<button />', {
                    class: 'slick-pause pause',
                    "aria-label": _.options.pauseLabel,
                    "data-action": 'pause'
                });
                ...
                svg.appendChild(getNode('polygon', {
                    class: 'pause',
                    points: '17 8 17 20'
                }));
                svg.appendChild(getNode('polygon', {
    ...
    Slick.prototype.initADA = function() {
        ...
        _.$slider.attr({
            ...
            'aria-label': _.options.ariaLabel || 'slide show'
        });

        _.$slideTrack.attr({
            'aria-atomic': false,
            'aria-live': _.options.autoPlay ? 'off' : 'polite'
        })
    ...
    Slick.prototype.updatePauseButton = function() {
        ...
        if (_.paused) {
            _.$pauseButton
                ...
                .attr({
                    'data-action': 'play',
                    'aria-label': _.options.playLabel
                })
